...
class T5Stack(T5PreTrainedModel):
    ...
    def forward(
        ...
        res=BaseModelOutputWithPastAndCrossAttentions(
        ...
        #$# cross attention的mask值只考虑encoder的padding问题
        # 存到encoder_outputs中，训练与预测都方便地供解码器使用
        if not self.is_decoder:
            res['cross_attention_mask']=(input_ids!=0)
...
class T5ForConditionalGeneration(T5PreTrainedModel):
    ...
    def forward(
        ...
        decoder_head_mask=None,
        cross_attn_head_mask=None,
        encoder_outputs=None,#$# 存入cross_attention_mask
        past_key_values=None,
        inputs_embeds=None,
        decoder_inputs_embeds=None,
        labels=None,
        ...
        if encoder_outputs is None:
            ...
            #$#
            encoder_attention_mask=encoder_outputs['cross_attention_mask']
        else:
            #$#
            encoder_attention_mask=encoder_outputs['cross_attention_mask']
